...
\name{Pierre Schutz}{}
\position{Software Engineer{\enskip\cdotp\enskip} Intern}

\mobile{(+33) 6 52 73 99 82}
\email{pierre.schutz@epfl.ch}
\homepage{pierreschutz.github.io}
\github{pierreschutz}
\linkedin{pierreschutz}
% \gitlab{gitlab-id}
